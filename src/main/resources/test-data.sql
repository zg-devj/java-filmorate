...
-- добовляем MPA
INSERT INTO mpas(mpa_name) VALUES ('G');
INSERT INTO mpas(mpa_name) VALUES ('PG');
INSERT INTO mpas(mpa_name) VALUES ('PG-13');
INSERT INTO mpas(mpa_name) VALUES ('R');
INSERT INTO mpas(mpa_name) VALUES ('NC-17');

-- добавляем фильмы
INSERT INTO films(
	mpa_id, film_name, description, release_date, duration, rate)
	VALUES (1, 'Комедия 1', 'Описание 1', '1990-11-12', 180, 1);

INSERT INTO films(
	mpa_id, film_name, description, release_date, duration, rate)
	VALUES (4, 'Драма 2', 'Описание 2', '2002-09-11', 210, 2);

INSERT INTO films(
	mpa_id, film_name, description, release_date, duration, rate)
	VALUES (5, 'Триллер 3', 'Описание 3', '2011-02-21', 192, 3);

INSERT INTO films(
	mpa_id, film_name, description, release_date, duration, rate)
	VALUES (3, 'Боевик 4', 'Описание 4', '2005-12-04', 90, 1);

INSERT INTO films(
	mpa_id, film_name, description, release_date, duration, rate)
	VALUES (1, 'Документальный 5', 'Описание 5', '2015-10-11', 190, 0);
